...
execute as @s at @s run summon minecraft:zombie ~ ~1.6 ~ {"HandItems":[{"Count":1,"id":"iron_sword","tag":{"Enchantments":[{"id":"unbreaking","lvl":1}]}},{}],"ArmorItems":[{"Count":1,"id":"leather_boots","tag":{display:{"color":16701501}}},{"Count":1,"id":"leather_leggings","tag":{"display":{"color":4673362}}},{"Count":1,"id":"leather_chestplate","tag":{"display":{"color":1908001},"Enchantments":[{"id":"unbreaking","lvl":1}]}},{"Count":1,"id":"iron_helmet"}],Tags:["gz-a4-newmob"]}
