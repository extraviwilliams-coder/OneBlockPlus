...
execute as @s at @s run summon minecraft:magma_cube ~ ~1.6 ~ {Size:3,Tags:["gz-a4-newmob"]}
execute as @s[scores={gz-a4-mobamount=2..}] at @s run summon minecraft:magma_cube ~ ~1.6 ~ {Size:3,Tags:["gz-a4-newmob"]}
