...
execute as @s at @s run summon minecraft:guardian ~ ~1.6 ~ {Tags:["gz-a4-newmob"]}
execute as @s[scores={gz-a4-mobamount=2..}] at @s run summon minecraft:guardian ~ ~1.6 ~ {Tags:["gz-a4-newmob"]}
