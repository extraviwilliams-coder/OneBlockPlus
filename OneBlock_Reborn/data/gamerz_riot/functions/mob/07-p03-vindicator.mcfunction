...
execute as @s at @s run summon minecraft:vindicator ~ ~1.6 ~ {HandItems:[{id:"minecraft:iron_axe",tag:{Enchantments:[{id:"knockback",lvl:1}]},Count:1},{}],Tags:["gz-a4-newmob"]}
execute as @s[scores={gz-a4-mobamount=2..}] at @s run summon minecraft:vindicator ~ ~1.6 ~ {HandItems:[{id:"minecraft:iron_axe",tag:{Enchantments:[{id:"knockback",lvl:1}]},Count:1},{}],Tags:["gz-a4-newmob"]}
