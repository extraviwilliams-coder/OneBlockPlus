...
execute as @s at @s run summon minecraft:spider ~ ~1.6 ~ {Attributes:[{Name:"generic.movement_speed",Base:0.5}],Tags:["gz-a4-newmob"]}
execute as @s[scores={gz-a4-mobamount=2..}] at @s run summon minecraft:spider ~ ~1.6 ~ {Attributes:[{Name:"generic.movement_speed",Base:0.5}],Tags:["gz-a4-newmob"]}
