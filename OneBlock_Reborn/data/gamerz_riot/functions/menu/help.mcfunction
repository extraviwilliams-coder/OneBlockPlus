...
execute if entity @e[scores={gz-a4-riot=7613..}] run tellraw @s [{"text":"  "},{"text": "[Phase 11: Cherry Fields]","color": "gold","clickEvent":{"action":"run_command","value":"/trigger gz-a4 set 71"},"hoverEvent":{"action":"show_text","value":"Open the help menu\nfor this phase!"}}]
execute if entity @e[scores={gz-a4-riot=8624..}] run tellraw @s [{"text":"  "},{"text": "[Phase 12: Idyll]","color": "gold","clickEvent":{"action":"run_command","value":"/trigger gz-a4 set 72"},"hoverEvent":{"action":"show_text","value":"Open the help menu\nfor this phase!"}}]
execute if entity @e[scores={gz-a4-riot=9724..}] run tellraw @s [{"text":"  "},{"text": "[Phase 13: The Deepdark]","color": "gold","clickEvent":{"action":"run_command","value":"/trigger gz-a4 set 73"},"hoverEvent":{"action":"show_text","value":"Open the help menu\nfor this phase!"}}]
execute if entity @e[scores={gz-a4-riot=10554..}] run tellraw @s [{"text":"  "},{"text": "[Phase 14: Desolated Lands]","color": "gold","clickEvent":{"action":"run_command","value":"/trigger gz-a4 set 74"},"hoverEvent":{"action":"show_text","value":"Open the help menu\nfor this phase!"}}]
execute if entity @e[scores={gz-a4-riot=11320..}] run tellraw @s [{"text":"  "},{"text": "[Phase 15: The End]","color": "gold","clickEvent":{"action":"run_command","value":"/trigger gz-a4 set 75"},"hoverEvent":{"action":"show_text","value":"Open the help menu\nfor this phase!"}}]
...
execute if entity @e[scores={gz-a4-riot=..9723}] run tellraw @s {"text": " ???","color": "white","italic": true}
execute if entity @e[scores={gz-a4-riot=..10553}] run tellraw @s {"text": " ???","color": "white","italic": true}
execute if entity @e[scores={gz-a4-riot=..11319}] run tellraw @s {"text": " ???","color": "white","italic": true}
