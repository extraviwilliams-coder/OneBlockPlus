...
execute as @s[scores={gz-a4-riot=16}] at @s align xz positioned ~0.5 ~ ~0.5 unless entity @e[tag=gz-a4-tutorial9] run summon minecraft:armor_stand ~-0.85 ~0.35 ~ {CustomName:'{"text":"Each phase has a §6different§r §aTheme §f& §aBiome§r!"}',"CustomNameVisible":1,Tags:["gz-a4-remove-on-skip","gz-a4-tutorial","gz-a4-tutorial9"],Invulnerable:1b,Invisible:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,Small:1b,Marker:1b}
...
execute as @s[scores={gz-a4-riot=46}] at @s align xz positioned ~0.5 ~ ~0.5 unless entity @e[tag=gz-a4-tutorial20] run summon minecraft:armor_stand ~-0.85 ~0.35 ~ {CustomName:'{"text":"Ready for an §aadventure§r?"}',CustomNameVisible:1b,Tags:["gz-a4-remove-on-skip","gz-a4-tutorial","gz-a4-tutorial20"],Invulnerable:1b,Invisible:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,Small:1b,Marker:1b}
